    ...
    <rasterrenderer opacity="1" alphaBand="-1" classificationMax="19" classificationMinMaxOrigin="User" band="1" classificationMin="1" type="singlebandpseudocolor">
      ...
      <rastershader>
        <colorrampshader colorRampType="EXACT" clip="0">
          ...
          <item alpha="255" value="11" label="Agricultura&#x9;" color="#e6a0c2"/>
          <item alpha="255" value="12" label="Agua&#x9;" color="#a5bfdd"/>
          <item alpha="255" value="13" label="Urbano" color="#c5c5c1"/>
          <item alpha="255" value="14" label="Minerias" color="#ff0101"/>
          <item alpha="255" value="15" label="Suelo desnudo" color="#f1f1e1"/>
          <item alpha="255" value="16" label="Aguajal" color="#7fd8bf"/>
          <item alpha="255" value="17" label="Bosque montano" color="#194e1e"/>
          <item alpha="255" value="18" label="Glaciar y nieve" color="#fef0e7"/>
          <item alpha="255" value="19" label="Matorral" color="#b2df8a"/>
          <item alpha="255" value="20" label="Pajonal andino" color="#00ff19"/>
          <item alpha="255" value="21" label="Pedregales" color="#ba88e2"/>
          <item alpha="255" value="22" label="Carreteras no pav." color="#c9c9c9"/>
          <item alpha="255" value="23" label="Carreteras pavimentadas" color="#818181"/>
